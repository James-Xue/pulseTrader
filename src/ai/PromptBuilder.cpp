...
[[nodiscard]] std::int64_t msToSeconds(std::int64_t ms)
{
    return ms / 1000;
}
...
[[nodiscard]] std::string formatPrice(double val)
{
...
[[nodiscard]] std::string formatVolume(double val)
{
    std::ostringstream oss;
