...
usage() {
    ...
    echo "  backtest ...            Offline strategy replay (M29/M33), see --help"
    echo "  kline-store ...         Daily 1m kline accumulation (M33), see --help"
    echo "  sweep ...               Parameter sweep over backtest (M33)"
